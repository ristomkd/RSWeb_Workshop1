...
namespace workshop_1.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["FirstTeacherId"] = new SelectList(teachers, "Id", "FullName", course.FirstTeacherId);
            ViewData["SecondTeacherId"] = new SelectList(teachers, "Id", "FullName", course.SecondTeacherId);
